<template>
    <div id="manage-module">
        <div class="query-wrapper">
            ...
            <div class="query-item-wrapper">
                <span class="query-label">类别编码：</span>
                <el-input class="query-input" v-model="queryParams['type_code']" placeholder="根据类别编码查询"></el-input>
            </div>
            <div class="query-item-wrapper">
            ...
            <div class="query-item-wrapper">
                <span class="query-label">农作物类型：</span>
                <el-select class="query-select" clearable v-model="queryParams['crop_type']" placeholder="请选择">
                    <el-option
                        v-for="item, key in categoryOptions['crop_type']"
                        :key="key"
                        :label="item"
                        :value="key">
                    </el-option>
            ...
            <div class="query-item-wrapper">
                <span class="query-label">是否非农用：</span>
                <el-select class="query-select" clearable v-model="queryParams['is_non_agricultural']" placeholder="请选择">
                    <el-option
                        v-for="item in categoryOptions['is_non_agricultural']"
                        :key="item"
                        :label="item"
                        :value="item">
                    </el-option>
...
export default {
    ...
    methods: {
        ...
        queryData(params) {
            const _this = this
            // 组合 url 和查询参数
            const baseUrl = "/api/arable/query_items"
            const queryParam = {
        ...
        queryDetail(row) {
            ...
            const baseUrl = "/api/arable/query_detail"
            const queryParam = {
