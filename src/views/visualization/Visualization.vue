<template>
    ...
    <time-slider @reload-layer="reloadLayer"></time-slider>
        ...
        <home-button :moduleId="moduleId"></home-button>
        <geocoder></geocoder>
        <zoom></zoom>
        ...
        <pitcher :moduleId="moduleId"></pitcher>
    </div>
</template>
...
import Zoom from "../../components/map-widgets/Zoom";
import HomeButton from "../../components/map-widgets/HomeButton";
import BasemapGallery from "./components/controls/BasemapGallery";
import Pitcher from "../../components/map-widgets/Pitcher";
import Geocoder from "../../components/map-widgets/Geocoder";
import HillShade from "../../components/map-widgets/HillShade";
import MapLegend from "./components/controls/Legend";
import ThreeDimension from "../../components/map-widgets/ThreeDimension";
