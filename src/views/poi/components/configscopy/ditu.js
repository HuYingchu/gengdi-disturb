...
const initialVisibility = 'visible'; // 默认可见性
    ...
    layers: [
        {
            ...
            source: {
                type: 'raster',
                tiles: [
                    'http://10.75.68.56:8080/geoserver/sccd/wms?service=WMS&version=1.1.0&request=GetMap&layers=sccd%3Aditu&bbox={bbox-epsg-3857}&width=768&height=710&srs=EPSG%3A3857&format=image%2Fpng&TRANSPARENT=TRUE',
                ],
            },
            layer: {
                id: 'ditu',
